  ...
  function renderTable(report) {
    ...
    report.trades.forEach((t,i)=>{
      ...
      exitRow.innerHTML = `
        ...
        <td class="num ${cls(theo)}">${fmtMoney(theo)}</td>
        <td class="num ${cls(cumTheo)}">${fmtMoney(cumTheo)}</td>
        <td class="num ${cls(real)}">${fmtMoney(real)}</td>
        <td class="num ${cls(cumReal)}">${fmtMoney(cumReal)}</td>
      `;
